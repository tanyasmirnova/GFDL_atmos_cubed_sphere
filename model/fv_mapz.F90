...
!-----------------------------------------------------------------------
  ...
  integer:: kdelz
#ifdef CCPP
  integer:: nt, liq_wat, ice_wat, rainwat, snowwat, cld_amt, graupel, hailwat, iq, n, kp, k_next
  integer :: ierr
#else
  integer:: nt, liq_wat, ice_wat, rainwat, snowwat, cld_amt, graupel, hailwat, iq, n, kmp, kp, k_next
#endif
