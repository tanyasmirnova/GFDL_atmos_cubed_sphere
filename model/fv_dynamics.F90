...
! Local Arrays
      ...
      integer :: sphum, liq_wat = -999, ice_wat = -999, hailwat = -999      ! GFDL physics
...
! mass fluxes
     ...
     if ( flagstruct%hord_tr<8 .and. flagstruct%moist_phys ) then
       ...
       if ( hailwat > 0 )  &
        call fill2D(is, ie, js, je, ng, npz, q(isd,jsd,1,hailwat), delp, gridstruct%area, domain, neststruct%nested, gridstruct%regional, npx, npy)
